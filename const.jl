...
const NR = 2  #桨叶片数
const Nbe = 10 #旋翼分段数量
const R = 1.05  #旋翼半径 量纲m
const ecut = 0.1 #桨叶根切比例 无量纲
const m_ = 0.35/R #桨叶质量密度 量纲kg/m
const Ω = 100  #旋翼转速 量纲rad/s
const αs = -2*π/180.0  #旋翼轴倾角  量纲rad
const Kβ = 0.0  #桨叶根部挥舞弹簧刚度 量纲？？？
const Iβ = m_/3*(1-ecut^3)*R^3  #桨叶挥舞惯量 量纲kg*m^2
# const R0 = 0.382  #lenght of root cut 量纲m
# const R1 = 0.136  #length of tip loss 量纲m
const vair = 50 # 来流速度 量纲 m/s
